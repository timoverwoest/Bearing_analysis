...
# x axis components
plot(b1[, "BPFI.x"], t="l", ylab="Density", main="B1 BPFI.x")
plot(b1[, "BPFI.y"], t="l", ylab="Density", main="B1 BPFI.y")
plot(b2[, "BPFI.x"], t="l", ylab="Density", main="B2 BPFI.x")
plot(b2[, "BPFI.y"], t="l", ylab="Density", main="B2 BPFI.y")
plot(b3[, "BPFI.x"], t="l", ylab="Density", main="B3 BPFI.x")
plot(b3[, "BPFI.y"], t="l", ylab="Density", main="B3 BPFI.y")
plot(b4[, "BPFI.x"], t="l", ylab="Density", main="B4 BPFI.x")
plot(b4[, "BPFI.y"], t="l", ylab="Density", main="B4 BPFI.y")
